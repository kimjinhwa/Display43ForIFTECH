...
static lv_i18n_phrase_t en_gb_singulars[] = {
    ...
    {"HF_Mode", "BAT 1st Low Vol"},
    {"R_C_Start_Run_Event", "R/C Start Run"},
    {"R_C_Re_Start_Event", "R/C Re-Start"},
    {"R_C_Stop_by_Command_Event", "R/C Stop by Command"},
    {"R_C_Stop_by_Fault_Event", "R/C Stop by Fault"},
    {"DC_DC_Start_Run_Event", "DC/DC Start Run"},
    {"DC_DC_Re_Start_Event", "DC/DC Re-Start"},
    {"DC_DC_Stop_by_Command_Event", "DC/DC Stop by Command"},
    {"DC_DC_Stop_by_Fault_Event", "DC/DC Stop by Fault"},
    {"Inverter_Start_Run_Event", "Inverter Start Run"},
    {"Inverter_Re_Start_Run_Event", "Inverter Re-Start Run"},
    {"Inverter_Stop_by_Command_Event", "Inverter Stop by Command"},
    {"Inverter_Stop_by_Fault_Event", "Inverter Stop by Fault"},
    {"Transfer_to_Inverter_Event", "Transfer to Inverter"},
    {"Transfer_to_Bypass_by_Com_Event", "Transfer to Bypass by Com"},
    {"Transfer_to_Bypass_by_fault_Event", "Transfer to Bypass by fault"},
    {"Inverter_Over_Current_fault", "Inverter OC fault"},
    ...
    {"input_over_voltage_fault", "input OV fault"},
    {"Input_Frequency_fault", "Input Frequency fault"},
    {"Battery_UV_Primary_Fault", "Bat UV 1st fault"},
...
static lv_i18n_phrase_t ko_kr_singulars[] = {
    ...
    {"DC_DC_OFF", "DC/DC 정지"},
    {"Converter_GDU", "컨버터 GDU 이상"},
    {"Inverter_GDU", "인버터 GDU 이상"},
    {"DC_DC_GDU", "DC-DC GDU 이상"},
    {"Common_GDU", "N상 GDU 이상"},
    {"Earth_fault", "지락 고장"},
    {"Fuse_Open", "배터리 퓨즈 이상"},
    {"EEPROM_Error", "메모리에러"},
    ...
    {"Battery_UV_Primary_Fault", "배터리 저전압 1차경보"},
