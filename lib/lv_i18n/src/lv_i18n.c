...
static lv_i18n_phrase_t ko_kr_singulars[] = {
    ...
    {"Vdc_link_OV_limit_fault", "직류링크 과전압 제한이상"},
    {"Vdc_link_UV_limit_fault", "직류링크 저전압 제한이상"},
    ...
    {"Battery_OV_limit_fault", "배터리 과전압 제한이상"},
    {"battery_UV_limit_fault", "배터리 저전압 제한이상"},
    {"inverter_output_voltage_fault", "인버터 출력전압 이상"},
