...
extern lv_obj_t * ui_TabSystemSet;
...
LV_IMG_DECLARE(ui_img_flowmain_png);    // assets/FlowMain.png
LV_IMG_DECLARE(ui_img_converteracdc_png);    // assets/ConverterAcDc.png
LV_IMG_DECLARE(ui_img_inverterdcac_png);    // assets/InverterDcAc.png
...
LV_FONT_DECLARE(ui_font_malbun32);
LV_FONT_DECLARE(ui_font_malbun52);
